...
class Player:
    def __init__(self, deck, name):
        ...
        # self.hand.append(deck.cards[0:5])
        del self.deck.cards[0:5]
    ...
    def play(self, card_index):
        ...
        2
        """
        card_play = self.hand[card_index]
...
class TutorCard(Card):
    ...
    def effect(self, opponent_card, player, opponent):
        ...
        after_change = []
        for i in range(3, len(opponent.hand)):
            after_change.append(opponent.hand[i])
        opponent.hand = after_change
        for i in range(3):
            opponent.draw()
...
class TACard(Card):
    ...
    def effect(self, opponent_card, player, opponent):
        ...
        300
        """
        opponent_card_attack = opponent_card.attack
        opponent_card_defense = opponent_card.defense
        opponent_card.attack = opponent_card_defense
        opponent_card.defense = opponent_card_attack
